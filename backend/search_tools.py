...
class CourseSearchTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": "Search course materials with course name matching",
            "input_schema": {
                "type": "object",
                "properties": {
                    "query": {
                    ...
                    "lesson_number": {
                        "type": "integer",
                        "description": "Specific lesson number (e.g. 1, 2, 3)",
                    },
                },
                "required": ["query"],
            },
...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": (
                "Get course outline with title, link, and lesson titles. "
                "Use for course structure or table of contents questions."
            ),
            "input_schema": {
                "type": "object",
                "properties": {
    ...
    def execute(self, course_name: str) -> str:
        ...
        # Track source for UI
        self.last_sources = [
            {"text": resolved_title, "link": course_data.get("course_link")}
        ]
